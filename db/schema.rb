...
ActiveRecord::Schema.define(:version => 20130919230436) do
  ...
  add_index "deployments", ["mci"], :name => "index_deployments_on_mci"
  add_index "deployments", ["security"], :name => "index_deployments_on_security"
